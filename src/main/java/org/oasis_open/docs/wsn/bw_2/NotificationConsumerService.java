 ...
 * 
 */
@WebServiceClient(name = "NotificationConsumerService", targetNamespace = "http://docs.oasis-open.org/wsn/bw-2", wsdlLocation = "file:/home/metteo/Downloads/bw-2.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/home/metteo/Downloads/bw-2.wsdl");
